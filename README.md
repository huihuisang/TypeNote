...
|---|---|---|
| ![Menu](screenshot/Menu.png) | ![Instruments](screenshot/乐器库.png) | ![Scores](screenshot/乐曲库.png) |
...
- **Note Bubbles** — Floating note animations as you type (optional)
- **Smart Mute** — Only plays when a text field has focus (optional, requires Accessibility permission)
